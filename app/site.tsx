...
const copy = {
  en: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Kathy currently serves Toronto, Richmond Hill, Markham, Vaughan, and Mississauga. Share your postal code when booking so she can confirm availability for your address.",
      },
    ],
    contact: {
  ...
  zh: {
    ...
    faqs: [
      ...
      { q: "服务哪些地区？", a: "目前服务地区包括多伦多、列治文山、万锦、旺市和密西沙加。预约时请提供邮政编码，方便确认你的地址是否在服务范围内。" },
    ],
    contact: {
      eyebrow: "联系 Kathy",
      title: "有问题？我们来帮你。",
      intro: "想了解服务范围、预约项目，或者有其他问题，欢迎联系我们。",
      formTitle: "联系我们",
